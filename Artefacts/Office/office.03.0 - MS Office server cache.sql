...
| DESCRIPTION                                                                      |
| The query looks for the Office server cache key in the registry. There are       |
| legitimate situations where office documents make web requests, and the cache is |
| logged on. The presence of a URL only means it was contacted, not that it was    |
| used in an attack.                                                               |
|                                                                                  |
| Version: 1.0                                                                     |
