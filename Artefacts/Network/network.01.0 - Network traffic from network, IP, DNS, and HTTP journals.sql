...
| DESCRIPTION                                                                    |
| Checks for network traffic in the network, IP, DNS, and HTTP journals. There is|
| a large amount of data in these logs and the query can run slowly. If you      |
| already have IOCs, then use 'Network.02.0'.                                    |
|                                                                                |
| VARIABLES                                                                      |
