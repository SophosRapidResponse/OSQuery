...
| DESCRIPTION                                                                    |
| Searches for a specific URL or user agent in the Sophos Browser Web Flow       |
| journals. The query returns detailed information about the traffic, such as    |
| process name, page status_code, user_agent, headers, cookies, and referrer page|
|                                                                                |
|  VARIABLES                                                                     |
