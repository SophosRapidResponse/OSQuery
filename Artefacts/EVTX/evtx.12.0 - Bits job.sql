...
| DESCRIPTION                                                                    |
| List all EID 59 in the Windows-Bits-Client/Operational event logs. Hunts for   |
| suspicious commands using the BITSAdmin tool and the Powershell cmdlet used to |
| start a BITs job in process journals within a time range.                      |
| TACTIC: Persistence                                                            |
|                                                                                |
| VARIABLES                                                                      |
