...
| DESCRIPTION                                                                    |
| Collect all login events from Terminal Services Local Session Manager. This    |
| query includes blank columns so data from this can be easily combined with the |
| other queries in this section which match the same format.                     |
|                                                                                |
| VARIABLES                                                                      |
