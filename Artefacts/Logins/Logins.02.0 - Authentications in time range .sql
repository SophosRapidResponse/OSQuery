...
|                                                                                |
| DESCRIPTION                                                                    |
| Uses the Sophos_winsec_journal which recorded information from the Security    |
| event log                                                                      |
|                                                                                |
| VARIABLES                                                                      |
...
|                                                                                |
| TIP                                                                            |
| Use wildcards for username/source_ip/logon_type if you want to bring all data  |
|                                                                                |
| Version: 1.3                                                                   |
