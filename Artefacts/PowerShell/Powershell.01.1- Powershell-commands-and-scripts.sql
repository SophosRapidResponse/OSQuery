...
| DESCRIPTION                                                                    |
| Gets all events (EID 400, 800) from the 'Windows PowerShell' event log and     |
| 'sophos_powershell_events' journal within a time range.                        |
| TACTIC: Execution                                                              |
|                                                                                |
| The sophos_powershell_events journal provides a cleaner version of the         |
