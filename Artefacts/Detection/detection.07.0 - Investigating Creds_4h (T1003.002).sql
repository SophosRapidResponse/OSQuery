...
| DESCRIPTION                                                                    |
| Retrieves Sophos detection: Creds_4h (T1003.002), indicative of the remote use |
| of the Impacket tool SecretsDump, which is leveraged to extract credentials    |
| from a remote host. This query extracts key details from the event, including  |
| the source IP address associated with the activity.                            |
|                                                                                |
| VARIABLES                                                                      |
